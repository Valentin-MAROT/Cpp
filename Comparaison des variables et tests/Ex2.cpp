...
int main() {
    ...
    {
        //int &b1 = fun3a(a); renvoie une rvalue
        int &b2 = fun3b(a); 
        //int &b3 = fun3c(a); // renvoie une rvalue
        //int &b4 = fun3d(); // renvoie une rvalue
        //int &b5 = fun3e(a); // renvoie une rvalue
        //int &b6 = fun3f(a); // renvoie une rvalue
    }

    {
        int &&b1 = fun3a(a);
        //int &&b2 = fun3b(a); // renvoie une rvalue
        int &&b3 = fun3c(a);
        int &&b4 = fun3d();
        //int &&b5 = fun3e(a); // renvoie une rvalue
        //int &&b6 = fun3f(a); // renvoie une rvalue
    ...
    {
        const int &&b1 = fun3a(a);
        //const int &&b2 = fun3b(a); Renvoie une rvalue
        const int &&b3 = fun3c(a);
        const int &&b4 = fun3d();
        //const int &&b5 = fun3e(a); Renvoie une rvalue
        const int &&b6 = fun3f(a);
    }

    {
        int *b1 = fun3A(&a);
        //int *b2 = fun3B(&a); renvoie une constante
        int *b3 = fun3C(&a);
        //int *b4 = fun3D(&a); renvoie une constante
    }
